export default function LogoMark({ size = 32 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
      ...
      <circle cx="23" cy="7" r="2.2" fill="#dc6414">
      ...
      <circle cx="23" cy="21" r="2.2" fill="#dc6414">
      ...
      <circle cx="14" cy="26" r="2.2" fill="#dc6414">
      ...
      <circle cx="5" cy="21" r="2.2" fill="#dc6414">
      ...
      <circle cx="5" cy="7" r="2.2" fill="#dc6414">
      ...
      <circle cx="14" cy="14" r="1.8" fill="#dc6414" opacity="0.4">
