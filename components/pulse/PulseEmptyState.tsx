    ...
    <div className="flex flex-col items-center justify-center text-center py-16 px-6 space-y-6">
      <div style={{ opacity: 0.3 }}>
        <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
          <circle cx="24" cy="24" r="22" stroke="#e8702a" strokeWidth="1.5" fill="none">
            <animate attributeName="r" values="20;22;20" dur="3.5s" repeatCount="indefinite" />
            <animate attributeName="opacity" values="0.6;1;0.6" dur="3.5s" repeatCount="indefinite" />
          </circle>
          <circle cx="24" cy="24" r="6" fill="#e8702a">
            <animate attributeName="opacity" values="0.7;1;0.7" dur="3.5s" repeatCount="indefinite" />
          </circle>
        </svg>
      </div>
      <div className="max-w-md space-y-2">
        <p className="lowercase text-[0.95rem] leading-relaxed" style={{ color: "#707070" }}>
        ...
        <p className="lowercase text-[0.95rem] leading-relaxed pt-2" style={{ color: "#c0c0c0" }}>
